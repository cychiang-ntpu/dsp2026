...
| 歷年題目 | 本學期歸屬 |
|---|---|
| Generating Sine Waves | HW1（`sine_wav_gen.c`） |
| 相子練習（交流電、電阻、電抗、阻抗講義 Problems 1–3） | HW1 Part A |
| Simulation of RC Low-Pass Filter by DSP | HW1 Part B |
| Transform Analysis: Examine the example | HW2 Part A |
| Filtering: Steady and Transient States（[2024 原文](archive/2024_hw3_filtering_steady_transient/)） | HW2 Part B |
| Linear/Minimum Phase Systems | HW2 Part B 第 6 題 |
| Changing Sampling Rates | HW3 |
| FFT Filters | HW4 |
